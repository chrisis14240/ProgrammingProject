...
public class OneServer implements Runnable {
    ...
    private OneServerThread clients[] = new OneServerThread[4];
    ...
    public static void main(String args[]) {
        String nPlayers = JOptionPane.showInputDialog(null, "Please enter the number of players (2-4)");
        OneServer server = null;
        Game game = new Game(Integer.parseInt(nPlayers));
    ...
    public void registerCommands() {
        ...
        commands.put(".acusse", new Acusse(this, game));
    }
